...
**Install packages:** The *tidyverse* will allow you to create graphs, and also includes functions to arrange the data. *corrplot* and *GGally* provide different ways of presenting data about correlation between variables, in a matrix. *RColorBrewer* provides us with a range of nice colour palettes.
